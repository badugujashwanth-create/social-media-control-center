...
Check the browser or terminal error first, then verify the documented environment variables and dependent services. Real OAuth and publishing require provider-owned credentials and review; some connectors are stubs or demo implementations.
